...
def render_mode_tab_content(mode_key, llm_col_sentiment, llm_col_reason, mode_title):
    ...
    with tab_view_tbl:
        ...
        st.dataframe(
            styled_df,
            column_config={
                "No": st.column_config.NumberColumn("𝐍𝐨", width="small"),
                "Author": st.column_config.TextColumn("𝐏𝐞𝐧𝐮𝐥𝐢𝐬", width="medium"),
                "Original Comment": st.column_config.TextColumn("𝐊𝐨𝐦𝐞𝐧𝐭𝐚𝐫 𝐀𝐬𝐥𝐢", width="large"),
                "Cleaned Comment": st.column_config.TextColumn("𝐊𝐨𝐦𝐞𝐧𝐭𝐚𝐫 𝐁𝐞𝐫𝐬𝐢𝐡 (𝐒𝐭𝐞𝐦𝐦𝐞𝐝)", width="medium"),
                "Likes": st.column_config.NumberColumn("𝐋𝐢𝐤𝐞𝐬", width="small"),
                "Time Description": st.column_config.TextColumn("𝐖𝐚𝐤𝐭𝐮", width="small"),
                "Lexicon Sentiment": st.column_config.TextColumn("𝐒𝐞𝐧𝐭𝐢𝐦𝐞𝐧 𝐋𝐞𝐱𝐢𝐜𝐨𝐧", width="small"),
                "LLM Sentiment": st.column_config.TextColumn("𝐒𝐞𝐧𝐭𝐢𝐦𝐞𝐧 𝐋𝐋𝐌", width="small"),
                "LLM Reason": st.column_config.TextColumn("𝐀𝐥𝐚𝐬𝐚𝐧 𝐋𝐋𝐌", width="medium"),
                "Ground Truth": st.column_config.TextColumn("𝐆𝐫𝐨𝐮𝐧𝐝 𝐓𝐫𝐮𝐭𝐡", width="small"),
            },
    ...
    with tab_edit_tbl:
        ...
        edited_df = st.data_editor(
            ...
            column_config={
                ...
                "No": st.column_config.NumberColumn("𝐍𝐨", width="small", disabled=True),
                "Author": st.column_config.TextColumn("𝐏𝐞𝐧𝐮𝐥𝐢𝐬", width="medium", disabled=True),
                "Original Comment": st.column_config.TextColumn("𝐊𝐨𝐦𝐞𝐧𝐭𝐚𝐫 𝐀𝐬𝐥𝐢", width="large", disabled=True),
                "Cleaned Comment": st.column_config.TextColumn("𝐊𝐨𝐦𝐞𝐧𝐭𝐚𝐫 𝐁𝐞𝐫𝐬𝐢𝐡 (𝐒𝐭𝐞𝐦𝐦𝐞𝐝)", width="medium", disabled=True),
                "Likes": st.column_config.NumberColumn("𝐋𝐢𝐤𝐞𝐬", width="small", disabled=True),
                "Time Description": st.column_config.TextColumn("𝐖𝐚𝐤𝐭𝐮", width="small", disabled=True),
                "Lexicon Sentiment": st.column_config.TextColumn("𝐒𝐞𝐧𝐭𝐢𝐦𝐞𝐧 𝐋𝐞𝐱𝐢𝐜𝐨𝐧", width="small", disabled=True),
                "LLM Sentiment": st.column_config.TextColumn("𝐒𝐞𝐧𝐭𝐢𝐦𝐞𝐧 𝐋𝐋𝐌", width="small", disabled=True),
                "LLM Reason": st.column_config.TextColumn("𝐀𝐥𝐚𝐬𝐚𝐧 𝐋𝐋𝐌", width="medium", disabled=True),
            },
            column_order=["No", "Author", "Original Comment", "Cleaned Comment", "Likes", "Time Description", "Lexicon Sentiment", "LLM Sentiment", "LLM Reason", "Ground Truth"],
            use_container_width=True,
